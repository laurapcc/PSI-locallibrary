...
def index(request):
    ...
    # CHALLENGE: count of genres and books containing a certain word
    num_genres = Genre.objects.all().count()
    num_books_contain_al = Book.objects.filter(title__icontains='a').count()
    ...
    context = {
        ...
        'num_books_contain_al': num_books_contain_al,
...
class LoanedBooksByStaffListView(
